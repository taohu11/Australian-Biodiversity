...
clc;
%%获得物种的列表
parentFolder = 'F:\TAO\Histrorical_impact\Quality_biodiversity\birds_not_done';
...
for i = 1:length(subFolders)
    ...
    name_wenjianjia = ['F:\TAO\Histrorical_impact\Quality_biodiversity\birds_not_done\'];
    biodiversity_name = ['F:\TAO\Histrorical_impact\Quality_biodiversity\birds_not_done\',species];
    ...
    %%输出tif
    geotiffwrite(['F:\TAO\Histrorical_impact\Quality_biodiversity\birds\',species,'.tif'],quality_biodiversity,R,'GeoKeyDirectoryTag',info.GeoTIFFTags.GeoKeyDirectoryTag);
end